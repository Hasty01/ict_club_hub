...
const ClubHubLogo = () => (
  <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-9 w-9 flex-shrink-0 filter drop-shadow-sm">
    ...
    <g transform="translate(13, 11) scale(0.6)">
        <path fillRule="evenodd" clipRule="evenodd" d="M38.8,1.7c0,0-2.4,1.4-2.8,4.1c-0.3,2.4,0.7,5.5,0.7,5.5s-0.3-2.1-1.7-3.4c-1.1-1-2.2-0.9-2.2-0.9s-1.2,0.1-2.2,1.1c-1.2,1.2-1.5,3.3-1.5,3.3s1.2-2.9,0.7-5.5C29.3,3.1,27,1.7,27,1.7s2.7,2,3.3,4.7c0.5,2.4-0.4,5.4-0.4,5.4s0.6-2.1,1.9-3.4c1.1-1,2.2-0.9,2.2-0.9s1.2,0.1,2.2,1.1c1.2,1.2,1.5,3.3,1.5,3.3s-1-2.9-0.4-5.4C41.8,3.7,38.8,1.7,38.8,1.7z M26.8,13c-0.4-0.7-1-1.4-1.5-2c-0.4-0.5-0.8-1-1.2-1.5c-0.3-0.4-0.6-0.8-0.8-1.2c-0.2-0.4-0.4-0.8-0.5-1.2C21.6,6.3,21.5,5.5,21.7,4.6c0.3-1.1,0.9-2.1,1.8-2.9c0.7-0.6,1.5-1,2.4-1.2c1.1-0.2,2.2,0,3.3,0.5c1,0.5,1.9,1.2,2.6,2.2c0.8,1,1.3,2.2,1.5,3.4c0.2,1.2,0,2.4-0.4,3.5c-0.4,1.1-1,2.1-1.8,2.9c-0.8,0.9-1.8,1.5-2.8,1.9c-0.4,0.1-0.7,0.2-1.1,0.3c-0.9,0.2-1.8,0.2-2.7-0.1c-0.8-0.2-1.6-0.6-2.2-1.2C27.3,14.7,27,13.9,26.8,13z M24.3,15.1c-1-0.2-2-0.5-2.9-1c-1-0.5-1.9-1.2-2.7-2c-1.3-1.4-2-3.1-2-5c0-1.8,0.7-3.4,2-4.7c1-1,2.3-1.6,3.6-1.8C24.1,0.2,25.8,0,27.5,0.4c1.6,0.4,3.1,1.2,4.3,2.4c1.3,1.3,2.2,2.9,2.5,4.7c0.3,1.7,0,3.5-0.8,5c-0.8,1.5-2,2.8-3.4,3.7c-1.4,0.9-3,1.4-4.6,1.4c-0.6,0-1.2-0.1-1.7-0.2c-0.2,0-0.4-0.1-0.6-0.1L24.3,15.1z M52.5,23.1l-5-2.1L43.8,19l-11-4.6l-11,4.6l-3.7,2.1l-5,2.1L8.3,27.5l-8,9.5l4.7,0.7L6,48.5l9.2-2.7L24.8,59l8.6-4.5l-1.3,14.7l5.2-1.8L36,53.4l11.4-1.9l2.7,9.7l5.2-1.8l-1.3-14.7l8.6,4.5l9.6-13.3l-9.2,2.7L58.2,27l4.7-0.7L55,16.8L52.5,23.1z M51.5,30.3c0,0-2-1.2-3.5-0.7s-2.1,2.2-2.1,2.2l-4.1,1.7l-4-9.8l10.9-4.5l2.8,6.8L51.5,30.3z" fill="white"/>
    </g>
  </svg>
);
