          ...
          case 'star':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-6 -mt-6 w-12 h-12 border border-yellow-400/50 rounded-full transition-all duration-300 ease-out
          ...
          case 'ring':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-6 -mt-6 w-12 h-12 border-2 border-orange-500 rounded-full transition-all duration-100 ease-linear
          ...
          case 'ghost':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 bg-gray-200/20 dark:bg-white/10 rounded-full blur-sm transition-all duration-500 ease-out
          ...
          case 'fire':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-6 -mt-6 w-12 h-12 bg-red-500/20 rounded-full blur-md transition-all duration-300 ease-out
          ...
          case 'ice':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-6 -mt-6 w-12 h-12 border border-cyan-200/50 bg-white/10 rounded-full backdrop-blur-sm transition-all duration-300 ease-out
          ...
          case 'music':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 border border-purple-400 rounded-full transition-all duration-300 ease-out
          ...
          case 'diamond':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 border border-blue-300/50 rotate-45 transition-all duration-300 ease-out
          ...
          case 'ufo':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-6 -mt-4 w-12 h-8 bg-green-500/10 rounded-[100%] border border-green-500/30 transition-all duration-500 ease-out
          ...
          case 'target':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-4 -mt-4 w-8 h-8 border border-red-600 rounded-full transition-all duration-100 ease-linear flex items-center justify-center
          ...
          case 'paw':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-6 -mt-6 w-12 h-12 border border-amber-600/30 rounded-full transition-all duration-300 ease-out
          ...
          case 'leaf':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 bg-green-500/10 rounded-full blur-sm transition-all duration-300 ease-out
          ...
          case 'rocket':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-6 -mt-6 w-12 h-12 border-2 border-dashed border-indigo-400 rounded-full transition-all duration-300 ease-out animate-spin-slow
          ...
          case 'smile':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 bg-yellow-400/20 rounded-full transition-all duration-300 ease-out
          ...
          case 'binary':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-4 -mt-4 text-green-500/50 font-mono font-bold text-sm transition-all duration-150
          ...
          case 'brush':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-3 -mt-3 w-6 h-6 bg-pink-500/30 rounded-full blur-sm transition-all duration-150
          ...
          case 'anchor':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-6 -mt-6 w-12 h-12 border-2 border-blue-700/30 rounded-full transition-all duration-300 ease-out
          ...
          case 'flower':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 bg-pink-400/20 rounded-full transition-all duration-300 ease-out
          ...
          case 'puzzle':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-6 -mt-6 w-12 h-12 border-2 border-dashed border-teal-500/50 rounded-lg transition-all duration-300 ease-out
          ...
          case 'pizza':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 bg-yellow-200/20 rounded-full blur-sm transition-all duration-300 ease-out
          ...
          case 'alien':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-6 -mt-6 w-12 h-12 border border-green-400/30 rounded-full bg-green-900/10 transition-all duration-300
          ...
          case 'basketball':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 border-2 border-orange-500/50 rounded-full transition-all duration-150
          ...
          case 'sword':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-4 -mt-4 w-8 h-8 bg-gray-200/10 rounded-full blur-sm transition-all duration-100
          ...
          case 'wand':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-4 -mt-4 w-8 h-8 bg-indigo-400/20 rounded-full blur transition-all duration-200
          ...
          case 'spider':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-6 -mt-6 w-12 h-12 border border-gray-400/30 rounded-full flex items-center justify-center transition-all duration-300
          ...
          case 'clock':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-6 -mt-6 w-12 h-12 border-2 border-dashed border-blue-400/40 rounded-full transition-all duration-300 animate-spin-slow
          ...
          case 'compass':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-6 -mt-6 w-12 h-12 border-2 border-red-500/20 rounded-full transition-all duration-300
          ...
          case 'film':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 border border-gray-500 rounded-md transition-all duration-150
          ...
          case 'gear':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 border-2 border-dashed border-gray-500/50 rounded-full transition-all duration-300
          ...
          case 'magnet':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 border border-red-500/30 rounded-full flex items-center justify-center transition-all duration-300
          ...
          case 'map':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-3 -mt-3 w-6 h-6 border-2 border-red-500 rounded-full transition-all duration-200 ease-out
          ...
          case 'medal':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 bg-yellow-200/20 rounded-full blur-sm transition-all duration-300
          ...
          case 'mic':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-6 -mt-6 w-12 h-12 border border-gray-400/30 rounded-full transition-all duration-200
          ...
          case 'palette':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 bg-gradient-to-tr from-pink-400 via-purple-400 to-blue-400 rounded-full opacity-20 transition-all duration-300
          ...
          case 'sun':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-6 -mt-6 w-12 h-12 border border-yellow-400/40 rounded-full transition-all duration-300 animate-spin-slow
          ...
          case 'moon':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 bg-indigo-900/20 rounded-full blur-sm transition-all duration-300
          ...
          case 'umbrella':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 border-t-2 border-blue-400/50 rounded-full transition-all duration-300
          ...
          case 'bomb':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 bg-red-500/10 rounded-full blur-md transition-all duration-150
          ...
          case 'robot':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 border border-gray-400/50 rounded-md transition-all duration-200
          ...
          case 'skull':
              return (
                  <>
                    ...
                    <div 
                        ref={followerRef}
                        className={`fixed top-0 left-0 pointer-events-none z-[9998] -ml-5 -mt-5 w-10 h-10 bg-gray-300/10 rounded-full blur-sm transition-all duration-300
